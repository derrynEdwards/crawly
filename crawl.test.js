...
test('<a href="https://example.com"></a> -> [ "https://example.com/" ]', () => {
    ...
    const inputBody = '<html><body><a href="https://example.com"><span>Example.com></span></a></body></html>';
...
test('<a href="/test/hello/"></a> -> [ "https://example.com/test/hello/" ]', () => {
    const inputUrl = 'https://example.com';
    const inputBody = '<html><body><a href="/test/hello/"><span>Example.com></span></a></body></html>';
    const actual = getURLsFromHTML(inputBody, inputUrl);
...
test('<a href="/test/hello/"></a><a href="https://www.example.com/path/two/"></a> -> [ "https://example.com/test/hello/", "https://www.example.com/path/two/" ]', () => {
    const inputUrl = 'https://example.com';
    const inputBody = '<html><body><a href="/test/hello/"><span>Example.com></span></a><a href="https://www.example.com/path/two/"><span>Example.com></span></a></body></html>';
    const actual = getURLsFromHTML(inputBody, inputUrl);
    const expected = [ "https://example.com/test/hello/", "https://www.example.com/path/two/" ];
